### A bricoleur bridging reality and data
...
- **Cromwell's rule** — never assign probability zero to anything. The Bayesian belief system: update, don't delete.
- **"다를 수도 있지"** — The slogan of a company that let me go, but the reason I joined in the first place. Still carries.
- **Art that puts you to sleep** — Max Richter's *Sleep*, minivanlife, and anything where nothing happens beautifully.
